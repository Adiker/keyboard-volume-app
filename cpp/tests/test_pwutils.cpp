...
TEST(PwUtils, LiMusicClientAndStandaloneMpvKeepSeparateTargets)
{
    QList<PipeWireGlobalProps> globals{
        {QStringLiteral("PipeWire:Interface:Client"), QStringLiteral("limusic"),
         QStringLiteral("limusic"), QString(), QString(), QStringLiteral("99")},
        {QStringLiteral("PipeWire:Interface:Client"), QStringLiteral("mpv"), QStringLiteral("mpv"),
         QString(), QString(), QStringLiteral("100")},
        {QStringLiteral("PipeWire:Interface:Node"), QStringLiteral("mpv"), QStringLiteral("mpv"),
         QStringLiteral("Stream/Output/Audio"), QStringLiteral("mpv"), QStringLiteral("141"),
         QStringLiteral("99")},
        {QStringLiteral("PipeWire:Interface:Node"), QStringLiteral("mpv"), QStringLiteral("mpv"),
         QStringLiteral("Stream/Output/Audio"), QStringLiteral("mpv"), QStringLiteral("142"),
         QStringLiteral("100")},
    };
    ...
    ASSERT_EQ(clients.size(), 2);
    EXPECT_TRUE(containsClient(clients, QStringLiteral("limusic"), QStringLiteral("limusic")));
    EXPECT_TRUE(containsClient(clients, QStringLiteral("mpv"), QStringLiteral("mpv")));
}
...
TEST(PwUtils, OwningClientOverridesEmbeddedRendererIdentity)
{
    ...
    node.clientName = QStringLiteral("limusic-app");
...
TEST(PwUtils, CurrentLiMusicClientMatchesConfiguredProfileWithoutClaimingMpv)
{
    PipeWireNode node;
    node.name = QStringLiteral("mpv");
    node.nodeName = QStringLiteral("mpv");
    node.clientName = QStringLiteral("limusic");
    node.clientBinary = QStringLiteral("limusic");

    EXPECT_TRUE(
        pipeWireNodeMatchesApp(node, appMatchCandidates(QStringLiteral("limusic-app"), {})));
    EXPECT_FALSE(pipeWireNodeMatchesApp(node, appMatchCandidates(QStringLiteral("mpv"), {})));
}

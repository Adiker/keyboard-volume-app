...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "pl": {
        ...
        "settings.preview_btn":             "Podgląd OSD",
        "settings.language":                "Język:",
        "settings.osd_screen":              "Ekran OSD:",
        "settings.screen_primary":          "główny",
        "settings.hotkeys_section":         "Skróty klawiszowe",
        "settings.hotkey.volume_up":        "Głośność w górę:",

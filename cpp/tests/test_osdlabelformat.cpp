...
TEST(OsdLabelFormat, EmptyTokenTrimsTrailingSeparator)
{
    ...
    t.artist.clear();
    const QString out =
        formatOsdLabelTemplate(QStringLiteral("{title} — {artist}"), t);
...
TEST(OsdLabelFormat, EmptyMiddleTokenCollapses)
{
    ...
    t.title.clear();
    const QString out =
        formatOsdLabelTemplate(QStringLiteral("{player} — {title} — {artist}"), t);
...
{
    const QString out =
        formatOsdLabelTemplate(QStringLiteral("{nope} {title}"), fullTokens());
...
TEST(OsdLabelFormat, TokenAppearsMultipleTimes)
{
    ...
    const QString out =
        formatOsdLabelTemplate(QStringLiteral("{title} {title} {title}"), t);

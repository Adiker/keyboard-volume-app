...
static const QMap<QString, QMap<QString, QString>> &strings()
{
    static const QMap<QString, QMap<QString, QString>> s {
        { QStringLiteral("en"), {
            ...
            { QStringLiteral("settings.profiles.col_app"),         QStringLiteral("App") },
        ...
        { QStringLiteral("pl"), {
            ...
            { QStringLiteral("settings.profiles.set_default"),     QStringLiteral("Ustaw jako domy\u015blny") },
            { QStringLiteral("settings.profiles.col_name"),        QStringLiteral("Nazwa") },
            { QStringLiteral("settings.profiles.col_app"),         QStringLiteral("Aplikacja") },
            { QStringLiteral("settings.profiles.col_modifiers"),   QStringLiteral("Modyfikatory") },
            { QStringLiteral("settings.profiles.col_volume_up"),   QStringLiteral("G\u0142o\u015bniej") },
